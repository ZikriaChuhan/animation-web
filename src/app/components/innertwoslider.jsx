            ...
            <div>
                <div className="flex items-center justify-center rounded-4xl bg-[#FFF000] overflow-hidden two-slider">
                    <div className="bg-[#FFF000] md:px-5 px-2">
                        <button
                            className="bg-[#281E3C] rounded-full ml-4 md:ml-0 cursor-pointer flex justify-center items-center w-10 h-10 md:w-20 md:h-20 p-1"
                            onClick={previous}
                        >
                            <Image
                                src={Arrowtop}
                        ...
                        <button
                            className="bg-[#0066FF] mt-4 rounded-full ml-4 md:ml-0 cursor-pointer flex justify-center items-center w-10 h-10 md:w-20 md:h-20 p-1"
                            onClick={next}
                        >
                            <Image
                                src={Arrowdown}
                            ...
                            <div key={1}>
                                <div className="bg-[#00AFDC] w-full h-full flex justify-between pl-12 pr-20 py-[2px] items-center relative">
                                    <Image
                                        ...
                                        width={310}
                                        height={160}
                                        className="absolute right-10 top-0 md:w-60 w-0"
                                    />
                                    <Image
                                        src={Character2}
                                        alt="Character2"
                                    ...
                                    <div className="relative md:p-0 py-10">
                                        ...
                                        <div className="flex justify-start items-center mt-4">
                                            <button className="mt-2 bg-white font-oswald text-black md:text-[14px] text-[10px] flex justify-center items-center gap-3 px-3.5 uppercase py-2 rounded-full">
