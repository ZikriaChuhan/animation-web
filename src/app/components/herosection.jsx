...
export default function HeroSection() {
  ...
  const handleSlideLeft = () => setIsBlue(true);
  const handleSlideRight = () => setIsBlue(false);
    ...
    <section className=" overflow-x-hidden overflow-y-visible">
      <section className="relative overflow-hidden  w-full text-white ">
        ...
        <div className="  flex flex-col justify-center items-center text-white pt-20 md:pb-84 pb-30 px-20 relative">
          <Image src={Shap1} alt={Shap1} width={125} height={129} className=" hidden md:flex absolute left-0 w-24" />
          <Image src={Shap2} alt={Shap2} width={235} height={165} className=" absolute md:left-[30%] top-0 w-44" />
          <Image src={Shap3} alt={Shap3} width={121} height={211} className="  absolute right-0 md:top-0 bottom-10 md:w-26 w-20" />
          ...
          <div className="flex md:flex-nowrap flex-wrap md:gap-16 py-12 md:px-24 justify-center items-center text-center">
            <div className="font-otomanopeeOne text-left">
              <h4 className="md:text-5xl text-2xl">ALL</h4>
              <h3 className="md:text-[80px] text-5xl leading-18">ANIMATION</h3>
              <h4 className="md:text-[38px] text-2xl">PROJECTS ACCEPTED</h4>
            </div>
            <div className=" text-left">
              <p className="mt-4 font-jost max-w-2xl mx-auto text-md">
      ...
      <section className="relative w-full text-white" >
        ...
        <div className=" text-white flex justify-center items-center flex-col pt-80 pb-80 text-center relative ">
          <div className="hidden md:flex md:flex-col absolute -left-44 top-60 uppercase -rotate-90 font-otomanopeeOne text-[#FFFFFF1A] text-8xl ">
            <h2>Animation</h2>
            <h2>Studio</h2>
          </div>
          ...
          <div className=" md:mt-[-660px] mt-[-450px] flex justify-center  ">
            <Image
              ...
              width={1100}
              height={800}
              className=" md:max-w-4xl md:p-0 px-3 "
            />
          </div>

          <h3 className="md:text-7xl text-5xl mt-4 max-w-3xl  mb-4 font-otomanopeeOne">ARE YOU READY FOR PROJECT</h3>
