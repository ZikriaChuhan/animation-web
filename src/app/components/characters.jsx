...
=======
            <section className="relative flex flex-wrap items-center justify-center py-24 px-2 overflow-hidden ">
                ...
                <div className="relative flex items-center justify-center vanellope-card">
                    ...
                    <Link href="https://www.facebook.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#BE08A6] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center absolute left-10 bottom-10 items-center rounded-full" rel="noopener noreferrer">
>>>>>>> 185bad5 (animate)
...
=======
                        <Link href="https://www.instagram.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#BE08A6] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center items-center rounded-full" rel="noopener noreferrer">
                            <Image src={Insta} alt="insta" className="" />
                        </Link>
                        <Link href="https://twitter.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#BE08A6] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center items-center rounded-full" rel="noopener noreferrer">
                            <Image src={Twiter} alt="twiter" className="" />
                        </Link>
                    </div>
                    <Link href="https://www.youtube.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#BE08A6] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center items-center  absolute right-10 bottom-10 rounded-full" rel="noopener noreferrer">
>>>>>>> 185bad5 (animate)
...
=======
                    <Link href="https://www.facebook.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#00C832] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center absolute left-10 bottom-10 items-center rounded-full" rel="noopener noreferrer">
>>>>>>> 185bad5 (animate)
                        <Image src={Fb} alt="fb" className="" />
                    </Link>
...
=======
                        <Link href="https://www.instagram.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#00C832] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center items-center rounded-full" rel="noopener noreferrer">
                            <Image src={Insta} alt="insta" className="" />
                        </Link>
                        <Link href="https://twitter.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#00C832] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center items-center rounded-full" rel="noopener noreferrer">
                            <Image src={Twiter} alt="twiter" className="" />
                        </Link>
                    </div>
                    <Link href="https://www.youtube.com/" target="_blank" className="hover:scale-[0.9] duration-100 bg-[#00C832] md:w-18 md:h-18 w-10 h-10 md:p-[20px] p-[12px] flex justify-center items-center  absolute right-10 bottom-10 rounded-full" rel="noopener noreferrer">
                        <Image src={Youtube} alt="youtube" className="" />
                    </Link>
                </div>
